...
class _ArticlePageState extends ConsumerState<ArticlePage> {
  ...
  Widget _buildRelatedList(int currentArticleId) {
    return Consumer(
      builder: (context, ref, child) {
        ...
        return latestNews.when(
          ...
          data: (articles) {
            final filtered = articles.where((a) => a.id != currentArticleId).toList();
            ...
            final mainContent = Column(
              ...
              children: [
                ...
                Text(
                  article.title,
                  style: TextStyle(
                    fontSize: (isMobile ? 20 : 26) * _textSizeMultiplier,
                    fontWeight: FontWeight.bold,
                    height: 1.3,
                  ),
                ...
                if (article.subtitle.isNotEmpty)
                  Text(
                    article.subtitle,
                    style: TextStyle(
                      fontSize: (isMobile ? 14 : 16) * _textSizeMultiplier,
